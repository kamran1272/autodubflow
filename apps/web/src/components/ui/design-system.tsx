...
const navigation = [
  ...
  { label: 'Agent Workspace', href: '/agent', disabled: true, disabledReason: 'Coming soon' },
  { label: 'Queue', href: '/queue' },
  { label: 'Schedule', href: '/schedule', disabled: true, disabledReason: 'Coming soon' },
  { label: 'Videos', href: '/videos', disabled: true, disabledReason: 'Coming soon' },
  { label: 'Source Channels', href: '/sources', disabled: true, disabledReason: 'Coming soon' },
  { label: 'Destination Channels', href: '/destinations', disabled: true, disabledReason: 'Coming soon' },
...
const commandItems = [
  ...
  { label: 'Settings', href: '/settings/account', shortcut: 'G S' },
